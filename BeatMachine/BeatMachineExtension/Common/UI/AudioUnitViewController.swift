...
private let log = Logger(subsystem: "BeatMachine.BeatMachineExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<BeatMachineExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try BeatMachineExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? BeatMachineExtensionAudioUnit else {
            log.error("Unable to create BeatMachineExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(BeatMachineExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = BeatMachineExtensionMainView(parameterTree: observableParameterTree)
